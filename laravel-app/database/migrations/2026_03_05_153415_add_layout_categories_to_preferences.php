...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('job_preferences', function (Blueprint $table) {
            ...
            $table->boolean('pref_formatting')->default(false);
            $table->boolean('pref_language')->default(false);
            $table->boolean('pref_conciseness')->default(false);
            $table->boolean('pref_organization')->default(false);
        });
    ...
    public function down(): void
    {
        Schema::table('job_preferences', function (Blueprint $table) {
            $table->dropColumn([
                'formatting_weight', 'language_weight',
